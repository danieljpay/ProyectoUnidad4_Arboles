        ...
        if(!jTextField4.getText().equals("")){
            ...
            if(numero){
                if(!(Integer.parseInt(jTextField4.getText()) < 1)){
                    ...
                    JOptionPane.showMessageDialog(this, "Ingrese un grado entero mayor o igual que 1", "Error!!", JOptionPane.WARNING_MESSAGE);
                }
            }
            else{
                JOptionPane.showMessageDialog(this, "Ingrese un grado entero mayor o igual que 1", "Error!!", JOptionPane.WARNING_MESSAGE); 
            ...
            JOptionPane.showMessageDialog(this, "Ingrese datos en el campo de texto", "Error!!", JOptionPane.WARNING_MESSAGE); 
        }
        jTextField4.setText("");
            ...
            if(numero){
                if(ya){
                    ...
                    if(esta){
                        ...
                        JOptionPane.showMessageDialog(this, "El elemento " + jTextField3.getText() + " no estaba en el arbol", "Novedad", JOptionPane.WARNING_MESSAGE);  
                    }
                }
                else{
                    JOptionPane.showMessageDialog(this, "Aun no ha creado un arbol", "Error!!", JOptionPane.WARNING_MESSAGE);
